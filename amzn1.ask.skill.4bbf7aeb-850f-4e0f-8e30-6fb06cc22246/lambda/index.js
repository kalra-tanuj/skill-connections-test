...
/* 
1. This function invokes skill-connections with the help of .addDirective uri contains a skill-id which is implementing HandleCTA task
2. TestIntentRequestHandler can be invoked by saying skill connections 
3. input field in .addDirective is task dependent and describes variables which are utilised by custom task 
*/
const TestIntentRequestHandler = {
  canHandle(handlerInput) {
     console.log("TestIntentRequestHandler called!");
     const request = handlerInput.requestEnvelope.request;
     return request.type === 'IntentRequest'
      && request.intent.name === 'TestIntent';
  },
  handle(handlerInput) {
     console.log("Skill-Connections .addDirective called!");
     return handlerInput.responseBuilder
        .addDirective({
             'type': 'Connections.StartConnection',
             'uri': 'connection://amzn1.ask.skill.f88c86d7-1d93-4abf-bb31-f26218bd818f.HandleCTA/1?provider=amzn1.ask.skill.f88c86d7-1d93-4abf-bb31-f26218bd818f',
